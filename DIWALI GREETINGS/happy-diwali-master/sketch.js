...
function draw() {
	...
	fill(211, 84, 0);
	textSize(25);
	text('If you are Indian and you love to party, have a happy, happy, happy', windowWidth/2, windowHeight/3);
	textSize(35);
	text('HAPPY DIWALEYYYYYYY', windowWidth/2, windowHeight/2)
	textSize(20);
	text('Pranav V 21VOA35', windowWidth/2 , (windowHeight*4)/5);
	if(random(1) < 0.03) {
